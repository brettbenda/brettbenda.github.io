...
Promise.all([d3.json("./pictures/pic.json/")]).then(function(json){
  console.log(json)
  var innerHTML = ""
  ...
  for(var i=0; i<json[0].images.length; i++){
      ...
      innerHTML += colStart
      innerHTML += "<img class=\"img-center img-thumbnail mx-auto d-block\" src=\""+fullpath+"\" style=\"margin-top: 10px; margin-bottom: 10px\">"
      innerHTML += "</div>"
